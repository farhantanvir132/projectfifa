  ...
  <div class="col-3">
    <div style="border-radius:15px; background-color:snow" class="p-3 border hov">
      ...
      <div class="stats1">
        ...
        <p style="color: #640127;font-size: 27px; text-align:center;padding:0px;">Admin's Prediction</p>
        <hr style="color: #640127;">
        <table>
        <tr>
        <td class="left_info" >  <img src="$fetchsrc$fetch[flagone]" alt="" width="50%" height="80%"></td>
        <td scope="row" class="info"><img src="flag/drawicon.png" alt="" width="30%" height="50%"></th>
